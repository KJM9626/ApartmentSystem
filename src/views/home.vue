    ...
    <div class="layout">
        <Sider :style="{position: 'fixed', height: '100vh', left: 0, overflow: 'auto'}">
            <Menu active-name="1-2" theme="dark" width="auto" :open-names="['1']">
                <MenuItem name="1" style="font-size:18px;" to="/home/dorm"><Icon type="ios-home" size="20"></Icon>公寓管理</MenuItem>
                <MenuItem name="2" style="font-size:18px;" to="/home/students"><Icon type="ios-contact" size="20"></Icon>学生管理</MenuItem>
